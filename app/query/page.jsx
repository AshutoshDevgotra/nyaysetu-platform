        ...
        {messages.length > 0 || loading ? (
          ...
          <div className="welcome-container">
            <div className="welcome-content">
              ...
              <p>Ask questions about Indian law, constitution, and legal acts. Our AI system will provide detailed responses based on legal documentation.</p>
              
              <div className="example-questions">
                <h4>Example questions:</h4>
                <div className="example-grid">
                  <button 
                    onClick={() => handleSearch("What are the fundamental rights under the Indian Constitution?")}
                  ...
                  <button 
                    onClick={() => handleSearch("What are the grounds for divorce under Hindu Marriage Act?")}
                    className="example-button"
                  >
